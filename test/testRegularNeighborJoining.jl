...
## input validation
@test_throws ArgumentError regNJ(rand(3,4))


@test regNJ(d) == NJClust{Int64, Float64}([-2 -1; -3 1; -4 2; -5 3], [3.0 2.0; 4.0 3.0; 2.0 2.0; 0.5 0.5])
t_d = readnw(NeighborJoining.newickstring(regNJ(d)))
